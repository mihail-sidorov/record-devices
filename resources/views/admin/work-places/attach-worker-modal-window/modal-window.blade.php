<div class="modal-window attach-worker-modal-window" ng-controller="attachWorkerToWorkPlaceAngularController">
    ...
    <div class="modal-window__wrapper">
        <div class="modal-window__content">
            ...
            <div class="modal-window__body">
                ...
                @include('admin.work-places.attach-worker-modal-window.form-content')
            </div>
        </div>
    </div>
</div>