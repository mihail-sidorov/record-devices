...
$(document).ready(() => {
    ...
    $('.admin-work-places-tab-content-controller .tab-content-wrapper__edit-work-place-btn').click((e) => {
    ...
    $('.admin-work-places-tab-content-controller .edit-component_part-modal-window .form-content__text, .admin-work-places-tab-content-controller .add-work-place-modal-window .form-content__text, .admin-work-places-tab-content-controller .edit-work-place-modal-window .form-content__text').on('input', (e) => {
    ...
    $('.admin-work-places-tab-content-controller .tab-content-wrapper__edit-component-part-btn').click((e) => {
        ...
        $.ajax({
            ...
            success: (response) => {
                if (response) {
                    $('.admin-work-places-tab-content-controller .edit-component_part-modal-window .form-content__field').each((index, element) => {
                        var $fieldNameElement = $(element).find('[name]'), fieldName = $fieldNameElement.attr('name'), date, year, month, day;
    ...
    $('.admin-work-places-tab-content-controller .edit-component_part-modal-window .form-content').on('submit', (e) => {
        var fields = $(e.currentTarget).serialize(), $formContentField;
